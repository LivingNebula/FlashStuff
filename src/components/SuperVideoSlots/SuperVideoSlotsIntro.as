package components.SuperVideoSlots
{
	...
	public class SuperVideoSlotsIntro extends SkinnableContainer implements IDisposable
	{
		// Logging
		private static const logger:DebugHelper = new DebugHelper( SuperVideoSlotsIntro );	
		...
		public function SuperVideoSlotsIntro( onStopCallback:Function )
		{
			// Log Activity
